...
movie_data = [{
    ...
    "poster_image": (
                    ...
                    "MV5BMTQ4MDI2MzkwMl5BMl5BanBnXkFtZTYw" +
                    "Mjk0NTA5._V1_UX182_CR0,0,182,268_AL_.jpg"
                    ),
    ...
    "storyline": (
                "A case of mistaken identity lands Slevin into the middle " +
    ...
    "poster_image": (
                    "http://ia.media-imdb.com/images/M/MV5BMzc1OTEwMTk4OF5" +
                    "BMl5BanBnXkFtZTcwMTEzMDQzMQ@@._V1_UY268_CR2,0,182," +
                    "268_AL_.jpg"
                    ),
    ...
    "title": "In Time",
    "storyline": (
                "In a future where people stop aging at 25, but are" +
    ...
    "poster_image": (
                "http://ia.media-imdb.com/images/M/MV5BMjA3NzI1ODc1MV5BMl5Ba" +
                "nBnXkFtZTcwMzI5NjQwNg@@._V1_UY268_CR5,0,182,268_AL_.jpg"
                ),
    ...
    "poster_image": (
                "http://ia.media-imdb.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5Ba" +
                "nBnXkFtZTcwNTI5OTM0Mw@@._V1_UX182_CR0,0,182,268_AL_.jpg"
                ),
    ...
    "storyline": (
                "A young man is accidentally sent thirty years into the " +
    ...
    "poster_image": (
                "http://ia.media-imdb.com/images/M/MV5BMjA5NTYzMDMyM15BMl" +
                "5BanBnXkFtZTgwNjU3NDU2MTE@._V1_UX182_CR0,0,182,268_AL_.jpg"
                ),
    ...
    "poster_image": (
                "http://ia.media-imdb.com/images/M/MV5BMjIyNTQ5NjQ1OV5BMl" +
                "5BanBnXkFtZTcwODg1MDU4OA@@._V1_UX182_CR0,0,182,268_AL_.jpg"
                ),
    ...
    "poster_image": (
                "http://ia.media-imdb.com/images/M/MV5BMjE4MjA1NTAyMV5BMl" +
                "5BanBnXkFtZTcwNzM1NDQyMQ@@._V1_UX182_CR0,0,182,268_AL_.jpg"
                ),
